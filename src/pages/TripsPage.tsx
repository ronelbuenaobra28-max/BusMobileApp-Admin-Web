...
export default function TripsPage() {
  ...
  return (
    <div className="space-y-4">
      <PageHeader
        title="Trips"
        description="View active, upcoming, and recent trips"
        action={
      ...
      <Card>
        ...
        {!isLoading && !error && filtered && filtered.length === 0 && (
          <EmptyState
            ...
            description="There are no trips matching your filters."
          />
        )}
              ...
              <tbody>
                {filtered.map((t) => (
                  ...
                  >
                    ...
                    <td className="px-4 py-3 text-slate-700">{t.bus_id}</td>
                    <td className="px-4 py-3 text-slate-700">{t.driver_id}</td>
                    ...
                    <td className="px-4 py-3 text-right">
                      <DropdownMenu>
                        ...
                        <DropdownMenuContent align="end">
                          <DropdownMenuItem onClick={() => navigate(`/trips/${t.id}`)}>
                            View details
                          </DropdownMenuItem>
                        </DropdownMenuContent>
                      </DropdownMenu>
